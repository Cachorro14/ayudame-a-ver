<div>
    <div class="flex flex-col overflow-y-auto md:flex-row">
        ...
        <div class="h-32 md:h-auto md:w-1/2">
            <img
                ...
                src="{{ asset('assets/img/AYUDAME2.png') }}"
            />
        </div>
            ...
            <div class="w-full">
                ...
                <label class="block text-sm">
                    ...
                    <input
                        ...
                        wire:model="email"
                    />
                    @error('email') <span class="text-danger error text-red-500">{{ $message }}</span>@enderror
                </label>
                <label class="block mt-4 text-sm">
                    ...
                    <input
                        ...
                        wire:model="password"
                    />
                    @error('password') <span class="text-danger error text-red-500">{{ $message }}</span>@enderror
                </label>
                ...
                <p class="mt-4">
                    <a
                        class="text-sm font-medium text-teal-300 hover:underline"
    ...
    <div class="col-md-12">
        ...
        <script>
            Swal.fire({
                icon: 'success',
                text: 'Se creo inicio sesion con exito', 
                showConfirmButton: false,
                footer: '<button type="button" class="swal2-confirm swal2-styled" aria-label="" style="display: inline-block;" wire:click="direct">OK</button>'
